...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtFilterAuth jwtFilterAuth, UserDetailsService userDetailsService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                // Put your JWT filter before the standard User/Password filter
    ...
    @Bean // Added @Bean so Spring can inject this into your Services
